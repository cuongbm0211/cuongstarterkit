...
import com.example.cuongstarterkit.repository.BookRepository;
...
// cuongbm
// This class can start with cli `mvn spring-boot:run`
// without start by intellij (need more investigate why)
